/**-----------------------
 ...
 docSlider2.js - ver.3.0.1
 URL : https://prjct-samwest.github.io/docSlider2/
 created by SamWest
...
const docSlider2 = (function () {
    ...
    const f = {
        ...
        createInner : function(){
            ...
            const wrapper = document.querySelector('.docSlider2');
            const inner   = document.createElement('div');
            const pages   = document.querySelectorAll('.docSlider2 > *:not(.docSlider2-pager)');

            inner.classList.add('docSlider2-inner');
            ...
            for(let i = 0; i < pages.length; i++){
                ...
                page.classList.add('docSlider2-page');
                page.classList.add('docSlider2-scroll');
        ...
        createPager : function () {
            ...
            const pageLength = document.querySelectorAll('.docSlider2-inner > *').length;

            if(document.querySelector('.docSlider2-pager')){

                const buttons = document.querySelectorAll('.docSlider2-button');
                ...
                pager.classList.add('docSlider2-pager');

                for(let i = 0; i < pageLength; i++){

                    let button = document.createElement('button');

                    button.classList.add('docSlider2-button');
                    button.setAttribute('data-ds-jump',i.toString());
                    button.setAttribute('tabindex','-1');
                ...
                document.querySelector('.docSlider2').appendChild(pager);
        ...
        setData : function () {
            ...
            d.wrapper = document.querySelector('.docSlider2');
            d.pages   = document.querySelectorAll('.docSlider2-inner > *');
            d.pager   = document.querySelector('.docSlider2-pager');
            d.buttons = document.querySelectorAll('.docSlider2-pager .docSlider2-button');
    ...
    const u = {
        ...
        pageChange : function(to){
            ...
            if(!speed){
                ...
                if(sc)
                    scrollCue._updateWithdocSlider2();
        ...
        updateClass : function(){
            ...
            d.html.classList.remove('docSlider2-index_' + pastIndex);
            d.html.classList.remove('docSlider2-page_'  + pastPage);
            d.html.classList.remove('docSlider2-id_'    + pastId);

            d.html.classList.add('docSlider2-index_' + nowIndex);
            d.html.classList.add('docSlider2-page_'  + nowPage);
            if(nowId) d.html.classList.add('docSlider2-id_'    + nowId);

            d.pages[d.past].classList.remove('docSlider2-current');
            d.pages[d.now].classList.add('docSlider2-current');
        ...
        wheel : function (e) {
            ...
            requestAnimationFrame(function () {
                ...
                for(let i = 0; i < elms.length; i ++){
                    ...
                    if(elm.classList.contains('docSlider2-scroll') && !u.scrollEnd(elm,distance))
                        return
        ...
        touchend : function (e) {
            ...
            for(let i = 0; i < elms.length; i++){
                ...
                if(elm.classList.contains('docSlider2-scroll') && !u.scrollEnd(elm,direction))
                    return;
    ...
    return {
        ...
        init : function (options) {
            ...
            sc = typeof scrollCue === 'undefined' ? false : scrollCue._hasdocSlider2();
            pcr = typeof scrollCue === 'undefined' ? false : scrollCue._hasPageChangeReset();

            if(sc){

                scrollCue._initWithdocSlider2(startHash);

            }

            op.complete(op, docSlider2.getElements());
