/**-----------------------
 ...
 docSlider3.js - ver.3.0.1
 URL : https://prjct-samwest.github.io/docSlider3/
 created by SamWest
...
const docSlider3 = (function () {
    ...
    const op = {
        speed        : 800,
        easing       : 'cubic-bezier(0.4, 0.2, 0, 1)',
        pager        : true,
        horizontal   : false,
        startSpeed   : null,
        scrollReset  : false,
    ...
    const f = {
        ...
        createInner : function(){
            ...
            const wrapper = document.querySelector('.docSlider3');
            const inner   = document.createElement('div');
            const pages   = document.querySelectorAll('.docSlider3 > *:not(.docSlider3-pager)');

            inner.classList.add('docSlider3-inner');
            ...
            for(let i = 0; i < pages.length; i++){
                ...
                page.classList.add('docSlider3-page');
                page.classList.add('docSlider3-scroll');
        ...
        createPager : function () {
            ...
            const pageLength = document.querySelectorAll('.docSlider3-inner > *').length;

            if(document.querySelector('.docSlider3-pager')){

                const buttons = document.querySelectorAll('.docSlider3-button');
                ...
                pager.classList.add('docSlider3-pager');

                for(let i = 0; i < pageLength; i++){

                    let button = document.createElement('button');

                    button.classList.add('docSlider3-button');
                    button.setAttribute('data-ds-jump',i.toString());
                    button.setAttribute('tabindex','-1');
                ...
                document.querySelector('.docSlider3').appendChild(pager);
        ...
        setData : function () {
            ...
            d.wrapper = document.querySelector('.docSlider3');
            d.pages   = document.querySelectorAll('.docSlider3-inner > *');
            d.pager   = document.querySelector('.docSlider3-pager');
            d.buttons = document.querySelectorAll('.docSlider3-pager .docSlider3-button');
    ...
    const u = {
        ...
        pageChange : function(to){
            ...
            if(!speed){
                ...
                if(sc)
                    scrollCue._updateWithdocSlider3();
        ...
        updateClass : function(){
            ...
            d.html.classList.remove('docSlider3-index_' + pastIndex);
            d.html.classList.remove('docSlider3-page_'  + pastPage);
            d.html.classList.remove('docSlider3-id_'    + pastId);

            d.html.classList.add('docSlider3-index_' + nowIndex);
            d.html.classList.add('docSlider3-page_'  + nowPage);
            if(nowId) d.html.classList.add('docSlider3-id_'    + nowId);

            d.pages[d.past].classList.remove('docSlider3-current');
            d.pages[d.now].classList.add('docSlider3-current');
        ...
        wheel : function (e) {
            ...
            requestAnimationFrame(function () {
                ...
                for(let i = 0; i < elms.length; i ++){
                    ...
                    if(elm.classList.contains('docSlider3-scroll') && !u.scrollEnd(elm,distance))
                        return
        ...
        touchend : function (e) {
            ...
            for(let i = 0; i < elms.length; i++){
                ...
                if(elm.classList.contains('docSlider3-scroll') && !u.scrollEnd(elm,direction))
                    return;
    ...
    return {
        ...
        init : function (options) {
            ...
            sc = typeof scrollCue === 'undefined' ? false : scrollCue._hasdocSlider3();
            pcr = typeof scrollCue === 'undefined' ? false : scrollCue._hasPageChangeReset();

            if(sc){

                scrollCue._initWithdocSlider3(startHash);

            }

            op.complete(op, docSlider3.getElements());
